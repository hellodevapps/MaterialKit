...
public class MKSwitchLayer: CALayer {
    ...
    var onColorPallete: MKSwitchColorPallete? {
        didSet {
            updateColors()
        }
    }
    var offColorPallete: MKSwitchColorPallete? {
        didSet {
            updateColors()
        }
    }
    var disabledColorPallete: MKSwitchColorPallete? {
        didSet {
            updateColors()
        }
    }
    ...
    func updateSuperBounds(bounds: CGRect) {
